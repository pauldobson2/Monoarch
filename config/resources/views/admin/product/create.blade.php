        ...
        <div class="mainCard pl-5 pr-5">
            ...
            <div class="secCard bg-white rounded-lg drop-shadow-xl">
                ...
                <div class="card-header">
                    <h3 class="card-title text-lg">Add Property</h3>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="d-flex flex-row mb-4">
                                    <div class="">
                                        ...
                                        <input type="text" name="garadge" value="{{ old('garadge') }}"
                                    ...
                                    <div class="ml-4">
                                        <label
                                            ...
                                            Feet</label>
                                        <input type="text" name="square_feet" value="{{ old('square_feet') }}"
                                ...
                                <div class="propertyFeatures">
                                    ...
                                    <div class="ml-4">
                                        <input class="" type="checkbox" id="air_conditioning"
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" cols="30" rows="10"
                                            class="form-control block w-full text-sm  @error('description') is-invalid @enderror"></textarea>
                                        @error('description')
                                            <p class="text-danger">{{ $message }}</p>
                                        @enderror
                                    </div>
