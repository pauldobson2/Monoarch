        ...
        function addDynamicContent() {
           ...
           <div class="dynamic-content" data-content-id="${contentCounter}">
                    ...
                    <div class="form-group">
                        ...
                        <img id="output" src="{{ asset('Image/blog/' . $blog->sub_image) }}"
                            width="80px" class="mt-1">
                        @error('image')
                            <p class="text-danger">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="form-group">
                        <label>Title</label>
                        <input type="text" value="${{ $blog->sub_title }}" name="sub_title[]" class="form-control" placeholder="Sub Title">
                    </div>
                    <div class="form-group">
                        <label>Description</label>
                        <textarea name="description" value="${{ $blog->sub_description }}" id="summernote" cols="30" rows="10"
