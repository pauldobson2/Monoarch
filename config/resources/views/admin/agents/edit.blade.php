        ...
        <div class="mainCard pl-5 pr-5 p-12">
            ...
            <div class="secCard bg-white rounded-lg drop-shadow-xl">
                <div class="card-header">
                    <h3 class="card-title text-lg font-sans">Update Agent</h3>
                </div>
                @if (session('success'))
                ...
                <div class="card-body p-4">
                        ...
                        <form action="{{ route('agent.update', $agent->id) }}" method="POST"
                            ...
                            <div class="d-flex flex-row mb-4">
                                ...
                                <div class="ml-4">
                                    ...
                                    <input type="text" name="phone_number" value="{{ $agent->phone_number }}"
                                ...
                                <div class="ml-4">
                                    ...
                                    <input type="text" name="linkedin" value="{{ $agent->linkedin }}"
                                ...
                                <div class="ml-4">
                                    ...
                                    <input type="text" name="whatsapp" value="{{ $agent->whatsapp }}"
                    ...
                    <div class="col-sm-10 ml-3 mb-4">
                        <input type="submit" name="submit" id="submit" value="Update Agent"
