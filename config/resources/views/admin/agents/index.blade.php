                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card-header">
                                        ...
                                        <div><a href="{{ route('agent.create') }}" class="btn btn-primary text-white"
                                                style="float:right; margin:10px;">Add Agent</a> </div>
                                    ...
                                    <tbody class="projectsTableBody">
                                        ...
                                        @foreach ($agents as $agent)
                                            ...
                                            <tr class="">
                                                {{-- {{ dd($product) }} --}}
                                                <td>{{ $i }}</td>
                                                <td> <img src="{{ asset('Image/agent/' . $agent->image) }}"
                                                        height="100px" width="120px"></td>

                                                <td>{{ $agent->name }}</td>
                                                <td>
                                                    <a href="{{ route('agent.show', $agent->id) }}"><i
                                                            class="fas fa-eye"></i></a>
                                                    <a href="{{ route('agent.edit', $agent->id) }}"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a data-target="#DeleteModal" data-toggle="modal" class="cancel"
                                                        data-id="{{ $agent->id }}"><i class="fas fa-trash"></i></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
