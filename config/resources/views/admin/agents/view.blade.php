        ...
        <div class="mainCard pl-5 pr-5 p-12">
            ...
            <div class="secCard bg-white rounded-lg drop-shadow-xl">
                <div class="card-header">
                    <h3 class="card-title text-lg font-sans">View Agent</h3>
                </div>
                @if (session('success'))
                        ...
                        <form action="{{ route('agent.update', $agent->id) }}" method="POST"
                            ...
                            <div class="col-md-12">
                                <div class="imageDiv">
                                    ...
                                    <input type="file" name="image"
                                        ...
                                        onchange="loadFile(event)" disabled>
                                    <img width="80px" id="output" class="mt-1 text-center"
                                        src="{{ asset('/Image/agent/' . $agent->image) }}" alt="">
                                    <div
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" name="name" value="{{ $agent->name }}"
                            ...
                            <div class="d-flex flex-row mb-4">
                                <div class="">
                                    ...
                                    <input readonly type="email" name="email" value="{{ $agent->email }}"
                                ...
                                <div class="ml-4">
                                    ...
                                    <input readonly type="text" name="facebook" value="{{ $agent->facebook }}"
                                ...
                                <div class="ml-4">
                                    ...
                                    <input readonly type="text" name="linkedin" value="{{ $agent->linkedin }}"
                                ...
                                <div class="ml-4">
                                    ...
                                    <input readonly type="text" name="whatsapp" value="{{ $agent->whatsapp }}"
