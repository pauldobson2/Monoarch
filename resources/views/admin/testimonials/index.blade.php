        ...
        <div id="DeleteModal" class="modal fade">
            <div class="modal-dialog modal-confirm">
                <div class="modal-content">
                    <form action="{{ route('testimonial_delete') }}" method="POST">
                        @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card-header">
                                        ...
                                        <div><a href="{{ route('show.form.testimonials') }}"
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($testimonials as $testimonial)
                                            ...
                                            <tr>
                                                {{-- {{ dd($product) }} --}}
                                                <td>{{ $i }}</td>
                                                <td> <img src="{{ asset('Image/testimonial/' . $testimonial->image) }}"
                                                ...
                                                <td>
                                                    <a href="{{ route('show.testimonial', $testimonial->id) }}"><i
                                                            class="fas fa-eye"></i></a>
                                                    <a href="{{ route('edit.form.testimonials', $testimonial->id) }}"><i
                                                            class="fas fa-edit"></i></a>
                                                    <a data-target="#DeleteModal" data-toggle="modal" class="cancel"
                                                        data-id="{{ $testimonial->id }}"><i
