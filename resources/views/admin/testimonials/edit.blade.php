                ...
                <div class="secCard bg-white rounded-lg drop-shadow-xl">
                    ...
                    <div class="card-body">
                        ...
                        <div class="basic-form">
                            ...
                            <form action="{{ route('update.form.testimonials', $testimonial->id) }}" method="POST"
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="imageDiv">
                                            ...
                                            <img id="output"
                                                src="{{ asset('Image/testimonial/' . $testimonial->image) }}" width="80px"
                                                class="mt-1">
                                            @error('image')
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea name="description" cols="30" rows="10"
                                                class="form-control @error('description') is-invalid @enderror">{{ $testimonial->description }}</textarea>
                                            @error('description')
                                                <p class="text-danger">{{ $message }}</p>
                                            @enderror
                                        </div>
