                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card-header">
                                        ...
                                        <div><a href="{{ route('create.category') }}" class="btn btn-primary text-white"
                                                style="float:right; margin:10px;">Add Categories</a> </div>
                                ...
                                <table id="example1" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($category as $category)
                                            ...
                                            <tr>
                                                <td>{{ $i }}</td>
                                                <td> <img src="{{ asset('Image/category/' . $category->image) }}"
                                                ...
                                                <td>
                                                    <a href="{{ route('view.category', $category->id) }}"><i
