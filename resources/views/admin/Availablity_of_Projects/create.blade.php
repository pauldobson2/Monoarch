...
@section('container')
@section('title', 'Add Available Projects')
            ...
            <div class="secCard bg-white rounded-lg drop-shadow-xl">
                ...
                <div class="card-body p-4">
                    ...
                    <div class="basic-form p-12">
                        ...
                        <form action="{{ route('availability.store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="col-md-12">
                            ...
                            <div class="d-flex flex-row mb-4">
                                <div class="">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Floor
                                        Number</label>
                                    <input type="text" name="floor" value="{{ old('number_of_floor') }}"
                                ...
                                <div class="ml-4">
                                    ...
                                    <input type="text" name="size" value="{{ old('facebook') }}"
                                ...
                                <div class="ml-4">
                                    ...
                                    <input type="text" name="price_sqt" value="{{ old('price_sqt') }}"
