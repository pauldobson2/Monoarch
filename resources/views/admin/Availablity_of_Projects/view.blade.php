...
@section('container')
@section('title', 'View Available Projects')
        ...
        <div class="mainCard pl-5 pr-5 p-12">
            ...
            <div class="secCard bg-white rounded-lg drop-shadow-xl">
                <div class="card-header">
                    <h3 class="card-title text-lg font-sans">View Availability of Space in Projects</h3>
                </div>
                @if (session('success'))
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label for="project_id"
                                        ...
                                        Project</label>
                                    <select @readonly(true) name="project_name" id="project_name"
                                        class="form-control">
                                        <option value="" disabled>Select a Project</option>
                                        @foreach ($projects as $project)
                                            <option value="{{ $project->name }}" selected disabled>{{ $project->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                </div>
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="form-group">
                                    ...
                                    <input readonly type="text" name="unit_type"
                                        value="{{ $availableProject->unit_type }}"
                            ...
                            <div class="d-flex flex-row mb-4">
                                <div class="">
                                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Floor
                                        Number</label>
                                    <input readonly type="text" name="floor" value="{{ $availableProject->floor }}"
                                ...
                                <div class="ml-4">
                                    ...
                                    <input readonly type="text" name="size" value="{{ $availableProject->size }}"
                                ...
                                <div class="ml-4">
                                    ...
                                    <input readonly type="text" name="price_sqt"
                                        value="{{ $availableProject->price_sqt }}"
                                ...
                                <div class="ml-4">
                                    ...
                                    <input readonly type="text" name="availability"
