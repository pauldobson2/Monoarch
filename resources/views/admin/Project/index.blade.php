                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="card-header">
                                        ...
                                        <div><a href="{{ route('project.create') }}" class="btn btn-primary text-white"
                                                style="float:right; margin:10px;">Add Projects</a> </div>
                                    ...
                                    <tbody class="projectsTableBody">
                                        ...
                                        @foreach ($projects as $project)
                                            ...
                                            <tr class="">
                                                {{-- {{ dd($product) }} --}}
                                                <td>{{ $i }}</td>
                                                <td> <img src="{{ asset('Image/project/' . $project->image) }}"
